...
enum GeofenceEvented3 { init, enter, exit }
...
class Geofenced3 {
  ...
  static Stream<GeofenceEvented3>? _geostream;

  /// [_controller] is Stream controller for geofence event stream
  static StreamController<GeofenceEvented3> _controller =
      StreamController<GeofenceEvented3>();
  ...
  static Stream<GeofenceEvented3>? getGeofenceStreamed3() {
    return _geostream;
  }
  ...
  static startGeofenceService(
    ...
    if (_positionStream == null) {
      ...
      _controller.add(GeofenceEvented3.init);
    }
  }
  ...
  static _checkGeofence(double distanceInMeters, double radiusInMeter) {
    if (distanceInMeters <= radiusInMeter) {
      _controller.add(GeofenceEvented3.enter);
    } else {
      _controller.add(GeofenceEvented3.exit);
    }
  }
