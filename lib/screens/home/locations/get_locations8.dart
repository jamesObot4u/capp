...
enum GeofenceEvented7 { init, enter, exit }
...
class Geofenced7 {
  ...
  static Stream<GeofenceEvented7>? _geostream;

  /// [_controller] is Stream controller for geofence event stream
  static StreamController<GeofenceEvented7> _controller =
      StreamController<GeofenceEvented7>();
  ...
  static Stream<GeofenceEvented7>? getGeofenceStreamed7() {
    return _geostream;
  }
  ...
  static startGeofenceService(
    ...
    if (_positionStream == null) {
      ...
      _controller.add(GeofenceEvented7.init);
    }
  }
  ...
  static _checkGeofence(double distanceInMeters, double radiusInMeter) {
    if (distanceInMeters <= radiusInMeter) {
      _controller.add(GeofenceEvented7.enter);
    } else {
      _controller.add(GeofenceEvented7.exit);
    }
  }
