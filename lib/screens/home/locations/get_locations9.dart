...
enum GeofenceEvented8 { init, enter, exit }
...
class Geofenced8 {
  ...
  static Stream<GeofenceEvented8>? _geostream;

  /// [_controller] is Stream controller for geofence event stream
  static StreamController<GeofenceEvented8> _controller =
      StreamController<GeofenceEvented8>();
  ...
  static Stream<GeofenceEvented8>? getGeofenceStreamed8() {
    return _geostream;
  }
  ...
  static startGeofenceService(
    ...
    if (_positionStream == null) {
      ...
      _controller.add(GeofenceEvented8.init);
    }
  }
  ...
  static _checkGeofence(double distanceInMeters, double radiusInMeter) {
    if (distanceInMeters <= radiusInMeter) {
      _controller.add(GeofenceEvented8.enter);
    } else {
      _controller.add(GeofenceEvented8.exit);
    }
  }
