...
enum GeofenceEvented5 { init, enter, exit }
...
class Geofenced5 {
  ...
  static Stream<GeofenceEvented5>? _geostream;

  /// [_controller] is Stream controller for geofence event stream
  static StreamController<GeofenceEvented5> _controller =
      StreamController<GeofenceEvented5>();
  ...
  static Stream<GeofenceEvented5>? getGeofenceStreamed5() {
    return _geostream;
  }
  ...
  static startGeofenceService(
    ...
    if (_positionStream == null) {
      ...
      _controller.add(GeofenceEvented5.init);
    }
  }
  ...
  static _checkGeofence(double distanceInMeters, double radiusInMeter) {
    if (distanceInMeters <= radiusInMeter) {
      _controller.add(GeofenceEvented5.enter);
    } else {
      _controller.add(GeofenceEvented5.exit);
    }
  }
