...
enum GeofenceEvented6 { init, enter, exit }
...
class Geofenced6 {
  ...
  static Stream<GeofenceEvented6>? _geostream;

  /// [_controller] is Stream controller for geofence event stream
  static StreamController<GeofenceEvented6> _controller =
      StreamController<GeofenceEvented6>();
  ...
  static Stream<GeofenceEvented6>? getGeofenceStreamed6() {
    return _geostream;
  }
  ...
  static startGeofenceService(
    ...
    if (_positionStream == null) {
      ...
      _controller.add(GeofenceEvented6.init);
    }
  }
  ...
  static _checkGeofence(double distanceInMeters, double radiusInMeter) {
    if (distanceInMeters <= radiusInMeter) {
      _controller.add(GeofenceEvented6.enter);
    } else {
      _controller.add(GeofenceEvented6.exit);
    }
  }
