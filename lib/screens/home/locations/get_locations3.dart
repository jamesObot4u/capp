...
enum GeofenceEvented2 { init, enter, exit }
...
class Geofenced2 {
  ...
  static Stream<GeofenceEvented2>? _geostream;

  /// [_controller] is Stream controller for geofence event stream
  static StreamController<GeofenceEvented2> _controller =
      StreamController<GeofenceEvented2>();
  ...
  static Stream<GeofenceEvented2>? getGeofenceStreamed2() {
    return _geostream;
  }
  ...
  static startGeofenceService(
    ...
    if (_positionStream == null) {
      ...
      _controller.add(GeofenceEvented2.init);
    }
  }
  ...
  static _checkGeofence(double distanceInMeters, double radiusInMeter) {
    if (distanceInMeters <= radiusInMeter) {
      _controller.add(GeofenceEvented2.enter);
    } else {
      _controller.add(GeofenceEvented2.exit);
    }
  }
