...
enum GeofenceEvented4 { init, enter, exit }
...
class Geofenced4 {
  ...
  static Stream<GeofenceEvented4>? _geostream;

  /// [_controller] is Stream controller for geofence event stream
  static StreamController<GeofenceEvented4> _controller =
      StreamController<GeofenceEvented4>();
  ...
  static Stream<GeofenceEvented4>? getGeofenceStreamed4() {
    return _geostream;
  }
  ...
  static startGeofenceService(
    ...
    if (_positionStream == null) {
      ...
      _controller.add(GeofenceEvented4.init);
    }
  }
  ...
  static _checkGeofence(double distanceInMeters, double radiusInMeter) {
    if (distanceInMeters <= radiusInMeter) {
      _controller.add(GeofenceEvented4.enter);
    } else {
      _controller.add(GeofenceEvented4.exit);
    }
  }
